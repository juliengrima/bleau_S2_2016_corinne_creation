...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Crete+Round|Days+One|Fredoka+One|Nunito|Parisienne|Pinyon+Script|Rochester|Sacramento|Sofia" rel="stylesheet"> 
                ...
                <nav id="menu-index" class="transparent">
                    <div class="nav-wrapper">
                        <div class="row valign-wrapper">
                            ...
                            <div class="valign col s12 m8" id="menu-index-text">
                                <ul id="nav-mobile" class="left hide-on-med-and-down">
                                    ...
                                    <div class="row">
                                        <li class="col s12 offset-m3">
                                            <a href="eco_label.php"><span id="idEcoLabel" class="navTextCC">Eco-label</span></a>                            
                                        </li>
                                    </div>
                                    <div class="row">
                                        <li class="col s12 m12">
                        ...
                        <div  class="row"> 
                            ...
                            <div class="col s6">
                                <a href="index.php"><img src="images/logo.png" alt="CorinneCreation" class="hide-on-large-only img-logo left"></a>
                            </div>
